...
// property_obj: 813
  ...
  async handleChange(e) {
    ...
    if(this.state.detailed_tax_expenses === "Y"){
      if(name === "medical_and_dental_expenses" ||
      ...
      name === "tax_deductible_casualty_and_theft_losses"){
        ...
        const validationErrorLength = this.Tax1YesValidators[e.target.name].errors
          .length;
    ...
    if(this.state.detailed_tax_expenses === "N"){
      ...
      if(name === "fedral_adjusted_gross_income"){
        ...
        const validationErrorLength = this.Tax1NoValidators[e.target.name].errors
          .length;
...
<span className="tooltip-img-text">If you itemize your deductions for a taxable year on
 Schedule A (Form 1040 or 1040-SR), Itemized Deductions PDF, you may be able to deduct
  ...
  deduct on Schedule A (Form 1040 or 1040-SR). Source: IRS</span>
        ...
        {displayValidationErrors(this.Tax1YesValidators, "medical_and_dental_expenses")}
        <MDBRow className="margin20">
          <MDBCol md="12">
            <span className="get-started-label">
        ...
        {displayValidationErrors(this.Tax1YesValidators, "state_local_generalsales_taxes")}
        <MDBRow className="margin20">
          <MDBCol md="12">
            <span className="get-started-label">
...
Refer to form 1040 and Publication 17 for details. Source: IRS </span>
        ...
        {displayValidationErrors(this.Tax1YesValidators, "tax_deductive_investment_interest")}
        <MDBRow className="margin20">
          <MDBCol md="12">
            <span className="get-started-label">
        ...
        {displayValidationErrors(this.Tax1YesValidators, "tax_deductible_charitable_donations")}
        <MDBRow className="margin20">
          <MDBCol md="12">
            <span className="get-started-label">
