    ...
    constructor(props) {
        ...
        if (
            ...
            if (this.CalculatorResponse && this.CalculatorResponse.dFRM1) {
                ...
                const TotalPayments = this.CalculatorResponse.dFRM1["Total Payments"];
                ...
                if (this.state.dfrm1.length > 0) {
                    ...
                    this.setState((prevState, props) => ({'scenarioData1': [this.state.dfrm1, ...prevState.scenarioData1]}))
                }
            ...
            if (this.CalculatorResponse && this.CalculatorResponse.dFRM2) {
                ...
                const TotalPayments = this.CalculatorResponse.dFRM2["Total Payments"];
                ...
                if (this.state.dfrm2.length > 0) {
                    ...
                    this.setState((prevState, props) => ({'scenarioData2': [this.state.dfrm2, ...prevState.scenarioData2]}))
                }
            }
            ...
            if (this.CalculatorResponse && this.CalculatorResponse.dARM1) {
                ...
                const TotalPayments = this.CalculatorResponse.dARM1["Total Payments"];
                ...
                if (this.state.darm1.length > 0) {
                    ...
                    this.setState((prevState, props) => ({'scenarioData1': [this.state.darm1, ...prevState.scenarioData1]}))
                }
            }
            ...
            if (this.CalculatorResponse && this.CalculatorResponse.dARM2) {
                ...
                const TotalPayments = this.CalculatorResponse.dARM2["Total Payments"];
                ...
                if (this.state.darm2.length > 0) {
                    ...
                    this.setState((prevState, props) => ({'scenarioData2': [this.state.darm2, ...prevState.scenarioData2]}))
                }
            }
            ...
            if (this.CalculatorResponse && this.CalculatorResponse.dsecond1) {
                ...
                const TotalPayments = this.CalculatorResponse.dsecond1[
                    "Total Payments"
                ];
                ...
                objYear.map((yr, index) => {
                    ...
                    if (this.state.dsecond1.length > 0) {
                        ...
                        this.setState((prevState, props) => ({'scenarioData1': [this.state.dsecond1, ...prevState.scenarioData1]}))
                    }
                });
            }
            if (this.CalculatorResponse && this.CalculatorResponse.dsecond2) {
                ...
                const TotalPayments = this.CalculatorResponse.dsecond2[
                    "Total Payments"
                ];
                ...
                if (this.state.dsecond2.length > 0) {
                    ...
                    this.setState((prevState, props) => ({'scenarioData2': [this.state.dsecond2, ...prevState.scenarioData2]}))
                }
...
dropChange = (event, value) => {
    if (event.target.value == 2) {
        ...
        if(!(this.CalculatorResponse && this.CalculatorResponse.dsecond2) || !(this.CalculatorResponse && this.CalculatorResponse.dsecond1)){
